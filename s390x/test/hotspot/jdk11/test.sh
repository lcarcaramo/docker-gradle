...
suite_start
        print_test_case "Image can be used to build a java projects:"
                build "builds-java-projects"
                docker run --rm --name builds-java-projects "builds-java-projects"
                cleanup "builds-java-projects"
suite_end
